...
class UserNotificationSettings(Base):
    ...
    notifications_enabled: Mapped[bool] = Column(Boolean, default=True, nullable=False)
    notify_15_minutes: Mapped[bool] = Column(Boolean, default=True, nullable=False)
    notify_30_minutes: Mapped[bool] = Column(Boolean, default=True, nullable=False)
    notify_60_minutes: Mapped[bool] = Column(Boolean, default=False, nullable=False)
